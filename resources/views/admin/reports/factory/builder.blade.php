...
$metricCount = 7; // order_count, line_count, pending_artwork, uploaded_artwork, manual_artwork, revision_count, avg_days_to_upload
    ...
    <div class="lg:hidden">
        ...
        <div x-show="mobileFieldsOpen" class="mt-2 space-y-3">
            ...
            <div class="card p-4">
                ...
                <div class="flex flex-wrap gap-2">
                    @foreach(['order_count' => 'Sipariş Sayısı', 'line_count' => 'Satır Sayısı', 'pending_artwork' => 'Bekleyen Artwork', 'uploaded_artwork' => 'Yüklenen Artwork', 'manual_artwork' => 'Manuel Tamamlanan Artwork', 'revision_count' => 'Revizyon Sayısı', 'avg_days_to_upload' => 'Ort. Yükleme (Gün)'] as $key => $label)
                        <button type="button"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <p x-show="selectedDimensions.length === 0 || selectedMetrics.length === 0" class="text-xs text-slate-400">En az bir boyut ve bir metrik seçin</p>
                <p x-show="hasResults && !loading" class="text-xs text-emerald-600 font-medium" x-text="rowCount + ' kayıt bulundu'"></p>
            ...
            <div x-show="hasResults" style="display:none" class="card p-5">
                ...
                <form id="save-form"
                    ...
                    <div class="flex flex-wrap gap-3">
                        <input type="text" name="name" x-model="reportName" placeholder="Rapor adı girin…" class="input flex-1 min-w-[200px]">
...
function reportBuilder() {
    return {
        ...
        async runPreview() {
            if (!this.selectedDimensions.length || !this.selectedMetrics.length) {
                return;
            }
