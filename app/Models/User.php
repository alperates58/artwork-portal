    ...
    public static function defaultPermissionsForRole(UserRole $role): array
    {
        return match ($role) {
            UserRole::PURCHASING => [
                ...
                'stock_cards' => ['view' => true, 'create' => false, 'edit' => false, 'delete' => false, 'bulk_import' => false],
                ...
                'artworks'    => ['upload' => false, 'approve' => false],
                'notes'       => ['internal' => true, 'supplier_only' => false],
            ...
            UserRole::GRAPHIC => [
                ...
                'stock_cards' => ['view' => false, 'create' => false, 'edit' => false, 'delete' => false, 'bulk_import' => false],
                'users'       => ['view' => false, 'create' => false, 'edit' => false],
                'departments' => ['view' => false, 'create' => false, 'edit' => false, 'delete' => false],
                'reports'     => ['view' => false, 'create' => false, 'save' => false],
                'artworks'    => ['upload' => true, 'approve' => false],
                'notes'       => ['internal' => true, 'supplier_only' => false],
