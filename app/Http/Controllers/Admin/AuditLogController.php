...
class AuditLogController extends Controller
{
    public const CATEGORIES = [
        ...
        'order' => ['order.view', 'order.create', 'order.update', 'order.delete', 'order_line.view', 'portal.order.view', 'order_line.manual_artwork.complete', 'order_line.revision.complete'],
    ...
    public const ACTION_LABELS = [
        ...
        'order_line.revision.complete' => 'Sipariş satırı revizyonu tamamlandı olarak işaretlendi',
    ...
    public const ACTION_COLORS = [
        ...
        'order_line.revision.complete' => 'emerald',
