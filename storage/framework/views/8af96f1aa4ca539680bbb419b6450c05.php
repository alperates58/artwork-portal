...
<html lang="tr">
<head>
    <?php echo $__env->make('partials.ui-head', ['title' => trim($__env->yieldContent('title', 'Artwork Portal'))], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</head>
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
            ...
            <?php if (! (auth()->user()->isSupplier())): ?>
                ...
                <a href="<?php echo e(route('orders.index')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('orders.*') ? 'active' : ''); ?>">
            ...
            <?php if(auth()->user()->isSupplier()): ?>
                <a href="<?php echo e(route('portal.orders.index')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('portal.*') ? 'active' : ''); ?>">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    Siparişlerim
                </a>
            <?php endif; ?>
            ...
            <?php if(auth()->user()->isAdmin()): ?>
                ...
                <a href="<?php echo e(route('admin.suppliers.index')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('admin.suppliers.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.logs.index')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('admin.logs.*') ? 'active' : ''); ?>">
